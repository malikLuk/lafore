 ...
 *
 *                                              Сортировка слиянием.
 * Сортировка слиянием по скорости превосходит сортировку пузырьком, вставками и еще какую-то простую (не помню какую).
 * Работает за O(N*logN). Недостаток ее в том, что она требует выделения доп памяти для доп массива размером, равным
 * размеру сортируемого массива.
 * Основная идея - слияние двух предварительно отсортированных массивов. Предположим, у нас есть два предвариетльно
 * отсортированных массива, причем они не обязательно должны быть одинакового размера. Допустим, массив А содержит 4
 * элемента, а массив Б - 6. Массивы объединяются посредством слияния в массив С, изначально состоящий из 10(4+6) пустых
 * ячеек. Допустим, массив А состоит из {23,47,87,95}, а массив Б из {7,14,39,55,62,74}. Тогда при их слиянии и заполнении
