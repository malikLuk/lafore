 ...
 *
 *                                                  Двусторонние списки.
 * Двусторонний список похож на обычный связный список с одной дополнительной возможностью: в нем хранится ссылка не
 ...
 * или удалении. Повышение эффективности может быть весьма значительным. Другое важное преимущество связных списков перед
 ...
 * использованию памяти(если массив слишком мал) или исчерпанию всей доступной памяти(если массив слишком велик).
 *
 **/
