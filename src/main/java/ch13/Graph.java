 ...
 *
 *                                                            Графы.
 * Граф как структура данных имеет много общего с деревом. Более того, в математическом смысле дерево является чатсным
 * случаем графа, но в программировании графы используются не так, как деревья. Стреоние графа часто определеяется
